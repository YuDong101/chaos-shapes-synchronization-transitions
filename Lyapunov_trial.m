C:\Users\Administrator\Desktop\czyfunction [mLCE] = Lyapunov_trial(pars)
...
% LCE = msf_LCE(x0, ...
%     @(x,t,pp) f_model(x,t,pp), ...
%     @(x,t,pp) Df_model(x,t,pp), ...
%     @(x,t,pp) DH_zero(x,t,pp), ...
%     dt, T_init, T_cal, 0, pars);
% LCE = sort(LCE,'descend')
...
function J = Df_model(x, t, pars) %#ok<INUSD>
    ...
    c   = pars.c;   b     = pars.b;     gamma = pars.gamma;
    k     = pars.k; G     = pars.G;
